...
// Your task is to complete the function isSubset() which takes the array a1[], a2[], its size n and m as inputs and return "Yes" 
...
// This is the logic of the code which is given in the question
for(int i = 0; i < n; i++){
            for(int j = 0; j < m; j++){
                if(a1[i] == a2[j]){
                    count++;
